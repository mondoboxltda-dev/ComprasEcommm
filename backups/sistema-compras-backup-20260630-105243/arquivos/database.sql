...
CREATE TABLE produtos (
  ...
  quantidade_por_unidade_compra DECIMAL(14,4) NOT NULL DEFAULT 1,
...
CREATE TABLE nfe_importacoes (
  id INT AUTO_INCREMENT PRIMARY KEY,
  ordem_id INT NULL,
  origem ENUM('XML','Manual') NOT NULL DEFAULT 'XML',
  fornecedor VARCHAR(150) NOT NULL,
...
CREATE TABLE historico_custos (
  ...
  quantidade_total_base DECIMAL(14,4) NOT NULL DEFAULT 0,
  valor_unitario DECIMAL(14,4) NOT NULL,
  valor_unitario_base DECIMAL(14,4) NOT NULL DEFAULT 0,
  valor_total DECIMAL(14,2) NOT NULL,
  origem VARCHAR(20) NOT NULL,
  recebimento_id INT NOT NULL,
  recebimento_item_id INT NOT NULL,
...
CREATE TABLE orcamentos (
  ...
  CONSTRAINT fk_orcamento_categoria FOREIGN KEY (categoria_id) REFERENCES cadastro_categorias(id)
);
