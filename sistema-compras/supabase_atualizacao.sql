...
-- Permissoes granulares por usuario e por aba
ALTER TABLE usuario_permissoes ADD COLUMN IF NOT EXISTS pode_adicionar SMALLINT NOT NULL DEFAULT 1;
ALTER TABLE usuario_permissoes ADD COLUMN IF NOT EXISTS pode_editar SMALLINT NOT NULL DEFAULT 1;
ALTER TABLE usuario_permissoes ADD COLUMN IF NOT EXISTS pode_excluir SMALLINT NOT NULL DEFAULT 1;
ALTER TABLE usuario_permissoes ADD COLUMN IF NOT EXISTS pode_aprovar SMALLINT NOT NULL DEFAULT 1;
ALTER TABLE usuario_permissoes ADD COLUMN IF NOT EXISTS pode_reprovar SMALLINT NOT NULL DEFAULT 1;
ALTER TABLE usuario_permissoes ADD COLUMN IF NOT EXISTS pode_exportar SMALLINT NOT NULL DEFAULT 1;
ALTER TABLE usuario_permissoes ADD COLUMN IF NOT EXISTS pode_visualizar_historico SMALLINT NOT NULL DEFAULT 1;
ALTER TABLE usuario_permissoes ADD COLUMN IF NOT EXISTS pode_gerenciar_usuarios SMALLINT NOT NULL DEFAULT 1;
...
CREATE INDEX IF NOT EXISTS idx_auditoria_sistema_modulo_data ON auditoria_sistema (modulo, criado_em DESC);
CREATE INDEX IF NOT EXISTS idx_auditoria_sistema_usuario_data ON auditoria_sistema (usuario_id, criado_em DESC);
